...
class employee extends axapta {
	...
	protected $modified_time      = 'MODIFIEDTIME - datepart(TZOFFSET, SYSDATETIMEOFFSET())*60'; //int(10)
	protected $modified_by        = 'MODIFIEDBY';                                                //varchar(5)

	protected $created_date       = 'CONVERT(DATE,CREATEDDATE)';                                 //date()
	protected $created_time       = 'CREATEDTIME - datepart(TZOFFSET, SYSDATETIMEOFFSET())*60';  //int(10)
